        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PagesInTotal = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuoteToRemember = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(nullable: false),
                    BookId = table.Column<int>(nullable: false),
                    StartedReadingOn = table.Column<DateTime>(nullable: false),
                    FinishedReadingOn = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PagesRead = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadingActivities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReadingActivities_UserBooks_UserBookId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingActivities_UserBookId",
